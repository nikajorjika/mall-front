          ...
          <div class="ads-single" v-if="$store.getters.searchFeatured.length">
            ...
            <div class="content-container">
              ...
              <div class="description">
                <p>
                  {{$store.getters.searchFeatured[0].description[locale].length > 120 ?
                  $store.getters.searchFeatured[0].description[locale].slice(0, 120) + '...' :
                  $store.getters.searchFeatured[0].description[locale]
                  }}</p>
              </div>
            </div>
          </div>
  ...
  computed: {
    searchingText: function () {
      const message = {
        ...
        ka: `ვაჩვენებთ ძებნის შედეგს სიტყვისთვის "${this.search}"`
      }
